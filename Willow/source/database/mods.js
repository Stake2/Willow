...
async function databaseModsCreateMod(id, name, allowed) {
  const res = await databaseQuery('INSERT INTO mods (mod_id, name, allowed) VALUES ($1, $2, $3) ON CONFLICT (mod_id) DO NOTHING', [id, name, allowed]);
